...
import { BlurbType, ContentBlurb } from "./content-blurb";
        ...
        <BarWrapper>
          ...
          >
            <Word>
              ...
              <IconWrapper>
                ...
                <svg viewBox="0 0 25 25" fill="currentColor" className="code w-6 h-6">
          ...
          >
            <Word>
              ...
              <IconWrapper>
                ...
                <svg viewBox="0 0 25 25" fill="currentColor" className="academic-cap w-6 h-6">
          ...
          >
            <Word>
              ...
              <IconWrapper>
                <svg viewBox="0 0 25 25" fill="currentColor" className="identification w-6 h-6">
